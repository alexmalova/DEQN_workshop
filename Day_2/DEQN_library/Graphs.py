...
# def do_policy_step(current_state):
#     return Dynamics.total_step_spec_shock(current_state, Parameters.policy(current_state), 1)
...
def run_episode(state_episode):
    ...
    # tf.print(current_state, summarize=-1)
    # shocked_state = do_policy_step(current_state)
    # tf.print(shocked_state, summarize=-1)
